<h2><a href="https://leetcode.com/problems/check-if-all-the-integers-in-a-range-are-covered/submissions/2050807720/?envType=problem-list-v2&envId=prefix-sum">check-if-all-the-integers-in-a-range-are-covered</a></h2>
